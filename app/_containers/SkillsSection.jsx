...
const SkillsSection = () => {
  return (
    <section
      id="skills"
      className="w-full flex items-center justify-center h-full border-r border-l border-[#2e2e2e] p-2 sm:p-8"
    >
          ...
          <div className="w-full h-full grid md:grid-cols-3 items-center justify-start s:grid-cols-2 grid-cols-1 border-b border-[#2e2e2e]">
            <div className="w-full h-64 flex items-end justify-end p-4 s:pl-0 s:border-r border-b border-[#2e2e2e]">
              <div className="w-full flex items-center justify-between text-white">
                <p className="w-[75%] h-full font-bold font-mattone text-xs sm:text-sm lg:text-base">RESPECT YOUR WORK AND THE WORK OF OTHERS</p>
